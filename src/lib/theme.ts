  ...
  todos: {
    ...
    colors: {
      ...
      button: {
        ...
        dashed: 'text-blue-600 border-blue-300 hover:border-blue-500 hover:text-blue-700'
      },
  ...
  notes: {
    ...
    colors: {
      ...
      button: {
        ...
        dashed: 'text-purple-600 border-purple-300 hover:border-purple-500 hover:text-purple-700'
      },
  ...
  financials: {
    ...
    colors: {
      ...
      button: {
        ...
        dashed: 'text-green-600 border-green-300 hover:border-green-500 hover:text-green-700'
      },

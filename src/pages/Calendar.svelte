<script lang="ts">
  ...
  // FAB actions - reactive based on view mode
  let fabActions = $derived.by(() => {
    ...
    // In sections view, show all actions
...
<!-- Header Component -->
<PageHeader title="Day View" icon="calendar">
  <!-- View mode switcher -->
  <Button
    onclick={() =>
  ...
  >
    ...
    <span class="text-sm font-medium text-gray-700 dark:text-gray-200">
      {viewMode === "timeline" ? "Sections" : "Timeline"}
    </span>
  </Button>
</PageHeader>

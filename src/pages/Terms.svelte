...
<div class="h-full flex flex-col">
  ...
  <div class="flex items-center gap-3 p-4 border-b border-gray-200">
    ...
    <div>
      <h1 class="text-xl font-semibold text-gray-900">Terms & Conditions</h1>
      <p class="text-sm text-gray-600">Updated June 30, 2025</p>
    </div>
  </div>
  ...
  <div class="flex-1 overflow-y-auto">
        ...
        <div class="prose prose-sm max-w-none">
          ...
          <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <div class="flex items-start gap-2">
              <Icon name="info-circle" class="text-blue-600 mt-0.5" size="sm" />
              <div class="text-sm">
                <div class="font-medium text-blue-900">Important</div>
                <div class="text-blue-700">Please read these terms carefully before using TempoDay.</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
            <div class="bg-gray-50 rounded-lg p-3">
              <div class="flex items-center gap-2 mb-2">
                ...
                <span class="font-medium text-gray-900">Task Management</span>
              </div>
              <p class="text-sm text-gray-600">Create and manage daily to-do lists</p>
            </div>
            <div class="bg-gray-50 rounded-lg p-3">
              <div class="flex items-center gap-2 mb-2">
                <Icon name="edit" class="text-purple-600" size="sm" />
                <span class="font-medium text-gray-900">Daily Notes</span>
              </div>
              <p class="text-sm text-gray-600">Write diary-like notes for each day</p>
            </div>
            <div class="bg-gray-50 rounded-lg p-3">
              <div class="flex items-center gap-2 mb-2">
                <Icon name="dollar" class="text-green-600" size="sm" />
                <span class="font-medium text-gray-900">Financial Tracking</span>
              </div>
              <p class="text-sm text-gray-600">Record income and expenses</p>
            </div>
            <div class="bg-gray-50 rounded-lg p-3">
              <div class="flex items-center gap-2 mb-2">
                <Icon name="calendar" class="text-orange-600" size="sm" />
                <span class="font-medium text-gray-900">Calendar View</span>
              </div>
              <p class="text-sm text-gray-600">Access all data through calendar interface</p>
            </div>
          </div>
        </div>
      {/snippet}
        ...
        <div class="prose prose-sm max-w-none text-gray-700">
          <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
            <div class="flex items-start gap-3">
              ...
              <div>
                <h4 class="font-medium text-green-900 mb-1">100% Local Storage</h4>
          ...
          <h4 class="font-medium text-gray-900 mb-2">What this means for you:</h4>
          <ul class="list-disc list-inside space-y-2 text-sm">
        ...
        <div class="prose prose-sm max-w-none text-gray-700">
          <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
            <div class="flex items-start gap-3">
              ...
              <div>
                <h4 class="font-medium text-red-900 mb-1">Voluntary Support</h4>
          ...
          <h4 class="font-medium text-gray-900 mb-2">Important Donation Terms:</h4>
          ...
          <h4 class="font-medium text-gray-900 mb-2">What donations support:</h4>
    ...
    >
      {#snippet children()}
        <div class="prose prose-sm max-w-none text-gray-700">
          ...
          <h4 class="font-medium text-gray-900 mb-2">Financial Tracking Disclaimer:</h4>
          <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-3">
            <div class="flex items-start gap-2">
              <Icon name="exclamation-triangle" class="text-yellow-600 mt-0.5" size="sm" />
              <div class="text-sm">
      ...
      {#snippet children()}
        <div class="prose prose-sm max-w-none text-gray-700">
          <div class="bg-indigo-50 border border-indigo-200 rounded-lg p-4 mb-4">
            <div class="flex items-start gap-3">
              <div class="w-8 h-8 bg-indigo-500 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                <Icon name="check-circle" class="text-white" size="sm" />
              </div>
              <div>
                <h4 class="font-medium text-indigo-900 mb-1">Open Source & Free Forever</h4>
          ...
          <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            <div class="flex items-start gap-2">
              <Icon name="exclamation-triangle" class="text-yellow-600 mt-0.5" size="sm" />
              <div class="text-sm">
                <div class="font-medium text-yellow-900">Commercial Use Restriction</div>
                <div class="text-yellow-700">
          ...
          <h4 class="font-medium text-gray-900 mb-2">Your rights and responsibilities:</h4>
          <ul class="list-disc list-inside space-y-2 text-sm">
      ...
      {#snippet children()}
        <div class="prose prose-sm max-w-none text-gray-700">
          ...
          <div class="space-y-3">
            ...
            >
              {#snippet children()}
                <Icon name="info-circle" class="text-blue-600" size="sm" />
    ...
    <div class="bg-gray-50 rounded-lg p-4 mb-6 text-center">
      <Icon name="check-circle" class="text-green-500 mx-auto mb-2" size="lg" />
      <h3 class="font-medium text-gray-900 mb-1">Thank you for using TempoDay!</h3>
